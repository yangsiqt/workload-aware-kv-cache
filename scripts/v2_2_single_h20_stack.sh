...
export V2_LITE_LOG_ROOT="${V2_2_SINGLE_H20_LOG_ROOT:-/root/log/workload-aware-kv-cache/v2-2-single-h20}"
export SMOKE_LMCACHE_CONFIG="${SMOKE_LMCACHE_CONFIG:-$ROOT/configs/v2_2_single_h20/lmcache.yaml}"
export SMOKE_ROUTER_CONFIG="${SMOKE_ROUTER_CONFIG:-$ROOT/configs/v2_2_single_h20/agent-slo-adaptive.yaml}"
export SMOKE_LMCACHE_INSTANCE_ID="${SMOKE_LMCACHE_INSTANCE_ID:-v2-2-single-h20}"
...
# A cold default mmap load and an explicit prefetch load were both about four
# minutes on this storage. Keep the established default unless explicitly set.
