...
export V2_LITE_LOG_ROOT="${V2_1_SINGLE_H20_LOG_ROOT:-/root/log/workload-aware-kv-cache/v2-1-single-h20}"
export SMOKE_LMCACHE_CONFIG="${SMOKE_LMCACHE_CONFIG:-$ROOT/configs/v2_1_single_h20/lmcache.yaml}"
export SMOKE_ROUTER_CONFIG="${SMOKE_ROUTER_CONFIG:-$ROOT/configs/v2_1_single_h20/agent-slo-adaptive.yaml}"
export SMOKE_LMCACHE_INSTANCE_ID="${SMOKE_LMCACHE_INSTANCE_ID:-v2-1-single-h20}"
